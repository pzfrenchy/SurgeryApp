 ...
 * @author Dan
 */
public class DocSearchClickListener implements ActionListener {
    ...
    public DocSearchClickListener(JTextField s, JTextField n, JTextField p, JTextField h, JTextField dob,
            JTextField r, JTextField doc, JTextField t, JTextField g, JTextField postcode,
            JList appList, JList docList, JList pNotes, JList pPrescriptions){
        super();
        this.searchField = s;
        this.name = n;
        this.phone = p;
        ...
        this.patientPrescriptions = pPrescriptions;
    }
