 ...
 * @author Dan
 */
public class PrtDocListener implements ActionListener, Printable{

    public PrtDocListener() {
    }
    ...
    public int print(Graphics g, PageFormat pf, int page) throws PrinterException {
        ...
        // render the document
        g.drawString("Doctors Appointments", 100, 100);
        //iterate through the list and print each string
        for (int i = 0; i < reports.getAllSchedules().size(); i++) {
            String rep = reports.getAllSchedules().get(i);
